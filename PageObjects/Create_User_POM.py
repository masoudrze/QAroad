...
class CreateUserPage:
    def __init__(self,driver):
        ...
        self.user_firstname_field = ((By.ID,"txtusername1"))
        self.user_firstname_field = ((By.ID,"txtpassword1"))
        self.user_firstname_field = ((By.ID,"RePassword"))
        self.user_firstname_field = ((By.ID,"Roles"))
        self.user_firstname_field = ((By.ID,"PasswordFaramooshi"))
        self.user_firstname_field = ((By.ID,"Personneli"))
        self.user_group_field = ((By.ID,"FirstName"))
        self.user_firstname_field = ((By.ID,"FirstName"))
        self.user_firstname_field = ((By.ID,"FirstName"))
        self.user_firstname_field = ((By.ID,"FirstName"))
        self.user_firstname_field = ((By.ID,"FirstName"))
