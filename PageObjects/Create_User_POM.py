...
class UserManagementPage(BasePage):
    def __init__(self, driver):
        ...
        self.new_button_locator = (
            By.XPATH,
            "//div[@ng-controller='ListStudentCtrl']//a[@title='فرد جدید']",
        )
        ...
        self.group_field_locator = (
            By.XPATH,
            "/html[1]/body[1]/div[3]/div[1]/section[2]/div[1]/div[1]/div[1]/form[1]/div[1]/div[1]/div[1]/div[3]/div[5]/div[1]/div[2]/div[3]/div[1]/span[1]/span[1]/span[1]",
        )
    ...
    def is_user_created(self, name):
        locator = (By.XPATH, f"(//td[normalize-space()='{name}'])[1]")
